    ...
    <nav class="nav-menu">
        <ul>
            ...
            <li><a href="{{ url('/vente_a_la_boutique') }}">Vente à la boutique ▼</a>
                <ul class="unroll">
                    <li><a href="/vente_a_la_boutique/pates_et_plat_cuisines">Pâtés et plats cuisinés</a></li>
                    <li><a href="/vente_a_la_boutique/viande_au_detail">Viande au détail</a></li>
                    <li><a href="/vente_a_la_boutique/caisettes_de_viande">Caissettes de viande</a></li>
                </ul>
            </li>
        </ul>
    </nav>
